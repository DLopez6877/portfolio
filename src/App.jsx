  ...
  return (
    <div className='container'>
      ...
      <div className='contact-info'>
        <h1>Daniel Lopez</h1>
        <p>Portland, Oregon - relocating to Las Vegas, Nevada</p>
        <p>
          Connect with me on{' '}
      ...
      <div id="resume-container">
        ...
        <div id="resume-images">
          <ZoomableImage src="/public/resume-page-1.webp" alt="Resume Page 1" title="Page 1" />
          <ZoomableImage src="/public/resume-page-2.webp" alt="Resume Page 2" title="Page 2" />
        </div>
        <button
          id="download-button"
          onClick={() => {
